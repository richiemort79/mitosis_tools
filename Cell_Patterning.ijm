...
//	Initialize Action Tool - Initializes the tracking and finds a population of cells to track. Specifies the future follicle condensate. If the manager remains empty see line 176.
...
var angle = 0;
var euc_dis = 0;
var step = 6;//the size of the analysis window in time steps
